...
```bash
# ---------------------------------------------------------------------
# CAUTION --> THE FOLLOWING COMMAND SHALL BE DONE EACH TIME YOU ATTACH!
...
# For iperf, since on `fit32` --> version is 2.0.13
root@4e44085d3d83:/iperf-2.0.5# /iperf-2.0.13/bin/iperf -c 12.1.1.2 -u -i 1 -t 10 -b 1M
------------------------------------------------------------
