...
# The 10 nodes selected by Farzaneh
default_node_ids = [1, 4, 5, 12, 15, 19, 27, 31, 33, 37]
...
def one_run(tx_power, phy_rate, antenna_mask, channel, *,
    ...
    init_olsr = [
        SshJob(
            ...
            verbose=verbose_jobs,
            command=RunScript("node-utilities.sh", "init-olsr")
            )
